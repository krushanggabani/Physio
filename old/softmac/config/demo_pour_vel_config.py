...
_C.SHAPES = [
    {
        "shape": "predefined",
        "offset": (0., 0.04, 0.),
        "path": Path("softmac/envs/pour/pour_mpm_init_state_corotated.npy"),
        "color": ((11 << 16) + (48 << 8) + 86)
    }
]
...
Bowl = CN()
Bowl.friction = 100.0  
Bowl.urdf_path = "softmac/assets/bowl/bowl.urdf"
Bowl.enable_external_force = False

Glass = CN()
Glass.friction = 10.0
Glass.urdf_path = "softmac/assets/glass/glass.urdf"
